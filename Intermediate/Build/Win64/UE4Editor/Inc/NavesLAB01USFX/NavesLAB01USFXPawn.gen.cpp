...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaMaxima_MetaData[] = {
		{ "Category", "Vida" },
		{ "Comment", "///////////////////////////\n" },
		{ "ModuleRelativePath", "NavesLAB01USFXPawn.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaMaxima = { "VidaMaxima", nullptr, (EPropertyFlags)0x0010000000000005, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANavesLAB01USFXPawn, VidaMaxima), METADATA_PARAMS(Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaMaxima_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaMaxima_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaActual_MetaData[] = {
		{ "Category", "Vida" },
		{ "ModuleRelativePath", "NavesLAB01USFXPawn.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaActual = { "VidaActual", nullptr, (EPropertyFlags)0x0010000000020015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANavesLAB01USFXPawn, VidaActual), METADATA_PARAMS(Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaActual_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaActual_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaMaxima,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ANavesLAB01USFXPawn_Statics::NewProp_VidaActual,
	};
